...
// ESL Champ
import EslChampionDashboard from "./components/esl_champion/EslChampionDashboard/EslChampionDashboard";

// Student
import StudentDashboard from "./components/student/StudentDashboard";
import StudentViewScores from "./components/student/eie-evaluations-scores/view-scores";

// Head POC
import HeadEiePocDashboard from "./components/head_eie_poc/eie-head-dashboard/HeadEiePocDashboard";
import EIEHeadReporting from "./components/head_eie_poc/eie-head-eie-reporting/eie-head-eie-reporting";
import MasterClassList from "./components/head_eie_poc/master-class-list/master-class-list";
import ImplementingSubjects from "./components/head_eie_poc/implementing-subjects/implementing-subjects";
import EIEHeadStudentManagement from "./components/head_eie_poc/eie-head-student-management/eie-head-student-management";
import EIEHeadGraduatingList from "./components/head_eie_poc/graduating-list/graduating-list";
import EIEHeadAssignPOC from "./components/head_eie_poc/assign_poc/assign_poc";
import EIEHeadDiagnosticReport from "./components/head_eie_poc/eie-diagnostic-reports/eie-diagnostic-reports";
import EIEHeadChampSelection from "./components/head_eie_poc/champion_list/eie-champs";

// Lead POC
import LeadEiePocDashboard from "./components/lead_eie_poc/lead-poc-dashboard/LeadEiePocDashboard";
import LeadPocReporting from "./components/lead_eie_poc/lead-poc-eie-reporting/lead-poc-eie-reporting";

// College POC
import CollegePocDashboard from "./components/college_poc/CollegePocDashboard/CollegePocDashboard";
import CollegePocImplementingSubject from "./components/college_poc/CollegePocClassManagement/CollegePocClassManagement";
import EPGFScorecard from "./components/college_poc/EPGFScorecard/EPGFScorecard";
import CollegePocEieReporting from "./components/college_poc/EIEreporting/EIEreporting";
import CollegePocStudentManagement from "./components/college_poc/StudentManagement/StudentManagement";

// ESL Prime
import EslPrimeEieReporting from "./components/esl_prime/EIE-reporting/esl-prime-eie-reporting";
import ElPrimeEPGFRubricVersion from "./components/esl_prime/EIE-management/epgf-rubric-version/esl-prime-epgf-rubric-versioning";
import EslCertification from "./components/esl_prime/EIE-management/certification/esl-prime-certification";
import EslTemplate from "./components/esl_prime/EIE-management/template/esl-template-champion";
import EslPrimeDashboard from "./components/esl_prime/EslPrimeDashboard/EslPrimeDashboard";
import EslInterviewScorecard from "./components/esl_prime/EIE-diagnostic/esl-interview-scorecard/esl-interview-scorecard";
import EslDiagnosticReports from "./components/esl_prime/EIE-diagnostic/eie-diagnostic-reports/eie-diagnostic-reports";
import EslImplementingSubjects from "./components/esl_prime/EIE-management/implementing-subjects/implementing-subjects";
import EslPrimeAccountManagement from "./components/esl_prime/EIE-management/accounts/esl-prime-account-management";
import EslAssignPOC from "./components/esl_prime/EIE-management/assign_poc/assign_poc";
